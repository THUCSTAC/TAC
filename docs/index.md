...
1. Traps and advice for new TAs (TA Panel / peer sharing)
2. Pedagogy for debugging
3. Office hours and tutoring
4. Discussion with a professor (邓俊辉)
5. Innovative design of programming assignments
6. CS education and games
7. K-12 CS education
8. Sharing by the undergraduate course-evaluation committee (本科生课调委)
9. Grading and plagiarism detection

### Syllabus of 2025 Spring

1. Traps and advice for new TAs (peer sharing, online)
2. Office hours and tutoring
3. Pedagogy for debugging
4. CS education and games
5. K-12 CS and AI education
6. Innovative design of programming assignments
7. Collecting and analyzing student feedback
8. Grading and plagiarism detection

### Syllabus of 2025 Autumn

1. Traps and advice for new TAs (peer sharing)
2. Teaching debugging (how to teach debugging techniques)

### Syllabus of 2026 Spring

1. Traps and advice for new TAs (new-TA peer sharing)
