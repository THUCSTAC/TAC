...
折中的方法可能是，公开/明确拿到基本合格分数的评分标准 (例如拿到作业的 60% 到 80% 分数的标准), 然后剩余部分的评分标准只给出大致的描述。
...
- [TOP2 计算机系，已经开始怀疑自己完全不适合相应领域的学习，未来的路应该如何走？](https://www.zhihu.com/question/349438744)
...
一种可能的思路是使用作业评分量表 (rubric)，来让判作业和给反馈变得更快。这大概类似于“40 秒判完一篇高考作文”。
...
曾经，严格的代码查重足以威慑大部分学生不进行抄袭。但近年来，Copilot、ChatGPT 等能理解和生成代码的大语言模型，给维护良好学风带来了更大的挑战。我们需要更多考虑从作业设计中，就鼓励学生独立完成。
