...
- [Attack Lab](https://csapp.cs.cmu.edu/) (CMU 15-213) — a classic programming lab, a representative of exemplary assignment design.
...
- *Debugging From Art to Science* (G. Aaron Wilkin, Rose-Hulman), course documents on [GitHub](https://github.com/4awilkin/debugging-art-to-science/).
- Delta Debugging (from *Why Programs Fail* Chapter 5) with the [Debugging Book](https://www.debuggingbook.org/) / [Fuzzing Book](https://www.fuzzingbook.org/).
