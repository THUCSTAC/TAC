...
整理历届助教培训中引用的计算教育/教学论文、书籍与工具，供感兴趣者进一步查阅。按主题分类。

## 编程作业 (Programming Assignments)

- [Attack Lab](https://csapp.cs.cmu.edu/) (CMU 15-213) —— 经典的编程实验，论文/案例级作业设计的代表。
- Prompt Problems: A New Programming Exercise for the Generative AI Era (SIGCSE 2024) —— 要求学生写一段 prompt 让 LLM 正确完成编程任务。
...
- *Debugging From Art to Science* (G. Aaron Wilkin, Rose-Hulman)，课程文档 [GitHub](https://github.com/4awilkin/debugging-art-to-science/)。
- Delta Debugging（源自 *Why Programs Fail* Chapter 5）与 [Debugging Book](https://www.debuggingbook.org/) / [Fuzzing Book](https://www.fuzzingbook.org/)。

## 答疑辅导与朋辈辅导 (Tutoring / Peer Tutoring)

- Brief, Just-in-Time Teaching Tips to Support Computer Science Tutors (SIGCSE 2024)。
- Inside the Mind of a CS Undergraduate TA (Julia M. Markel and Philip J. Guo, SIGCSE 2021, Best Paper) —— [PDF](https://pg.ucsd.edu/publications/cs-undergrad-lab-tutoring-experiences_SIGCSE-2021.pdf)。
...
- Stanford CS198 的 Debugging/Teaching Preparation & Evaluation Worksheet。

## 计算机教育与游戏 (CS Education & Games)

- Perfect Snake: Exploring Algorithms Through the Snake Game (SIGCSE 2024) —— A*、汉密尔顿回路、Q-learning。
...
- 有算法/计算机背景的游戏：图灵完备、装机模拟器；智能体大赛 Saiblo 平台；CPDuels。

## 中小学编程与 AI 教育 (K-12)

- Seymour Papert《Mindstorms: Children, Computers, and Powerful Ideas》—— 发明 Logo，愿景是"让儿童通过编程学会数学，而非计算机控制儿童"。
- 《义务教育信息科技课程标准（2022 年版）》。
- CCF GESP 分级大纲 (https://gesp.ccf.org.cn/)。
- 教育部《关于加强中小学人工智能教育的通知》—— 2030 年前在中小学普及人工智能教育。
- 《不插电的计算机科学》 (csunplugged)。

## 评分与查重 (Grading & Plagiarism Detection)

- Stanford MOSS。
- MIT 关于代码协作/诚信的说明 (https://integrity.mit.edu/handbook/writing-code) 及其中文版。
- 清华 lab.cs.tsinghua.edu.cn 的查重工具与演示。
- CATME 同伴互评 (https://info.catme.org/features/peer-evaluation/) 与五个维度。

## 小助教/同伴导学 (Peer Learning)
