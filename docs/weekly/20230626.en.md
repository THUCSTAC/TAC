...
!!! warning "Delayed publication"
    Due to time constraints, we're placing the selected modules here first and will write detailed descriptions later.

## **One Course**

Tsinghua University *Data Structures* https://dsa.cs.tsinghua.edu.cn/~deng/ds/dsacpp/index.htm

## **One Assignment**

Tsinghua University *Computer Networks* — software/hardware router lab
