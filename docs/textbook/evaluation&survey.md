...
线下研讨将主要围绕这四个讨论话题展开:
话题1: 同样是反馈/改进的机制，学生教评和论文审稿有什么不同？
话题2: 根据访谈材料，同学们倾向于给一节什么样的课打最高/最低的教评分数？反映了对课程的哪些期待？
话题3: 如何制作一份课前调研问卷？
话题4: 那些”失败“的课程改进措施，为什么让我们有挫败感？
...
- 确保课程团队对于反馈数据的收集、解读和使用能达成共识。有时需要教师拍板。
...
对一个初步的课程改进想法或课程改进方案，想要提升其可行性，就需要尽可能地多做调研、讨论、收集反馈。但也没办法无止境地做可行性分析，有些时候只能在实际的课程里先一点点尝试做起来。无论如何，对于自己拿不准的课程剧烈改动，也不要一下子就在课程里完全实施，找一些逐步将其纳入课程的方法，时刻注意学生对这些变化的反馈。或者说，要设想最坏的场景：在最糟糕的情况下，这个课程改进方案会导致什么后果? 有什么应对方法吗？ 在后果基本可控的情况下，可以大胆一些。
